class TextFieldWidgetConfig extends MovieClip {
  ...
  function TextFieldWidgetConfig() {
    initialize();
    about_to_exit = false;
  ...
  function gotParameters(x) {
    ...
    if (_root.params["config_tfsize"] != undefined) tfsize.text = _root.params["config_tfsize"];
  }
  ...
  function buttonAction() {
    ...
    _root.params["config_tfsize"] = tfsize.text;
    about_to_exit = true;
  ...
  function initialize() {
    ...
    // set the main text
    setText("TextFieldWidget configuration\n\nURL\n\n\nDelay (milliseconds)\n\n\nFont Size");

    createTextField("inputURL", 9, 10, 60, 298, 20);
    inputURL = this["inputURL"];
    inputURL.border = true;
    inputURL.type = "input";
    //inputURL.text = "http://10.210.211.231/kv.php?chumby=1";
    inputURL.text = "http://192.168.0.117:10000/kv.php?chumby=1";

    // create and format the two input text fields
    createTextField("inputDelay", 8, 10, 100, 298, 20);
    inputDelay = this["inputDelay"];
    inputDelay.type = "input";
    inputDelay.border = true;
    inputDelay.text = "5000";


    createTextField("tfsize", 10, 10, 140, 298, 20);
    tfsize = this["tfsize"];
    tfsize.border = true;
    tfsize.type = "input";
    tfsize.text = "12";
